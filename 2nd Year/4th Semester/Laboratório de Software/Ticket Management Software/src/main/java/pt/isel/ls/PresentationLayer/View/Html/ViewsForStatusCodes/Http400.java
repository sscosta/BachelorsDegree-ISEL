...
public class Http400 extends ViewHtml {

    private static final String TITLE = "Http 400";
    private final String message;
    Html html;
    Body body;
    public Http400(Result result, RequestContext requestContext, String message) {
