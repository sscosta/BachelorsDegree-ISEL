...
public class Http404 extends ViewHtml {
    private static final String TITLE = "Http 404";
    private final String message;
    Html html;
    Body body;
    public Http404(Result result, RequestContext requestContext, String message) {
