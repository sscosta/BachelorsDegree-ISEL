...
public class Loader {
    ...
    private Circuit model;      // The loaded modelGame
     ...
     * @return The modelGame for the loaded level
    ...
    public Circuit load(int level) throws LevelFormatException {
        ...
        model = new Circuit(height,width);  // Build the modelGame
    ...
    private void loadGrid() throws LevelFormatException {
        for(int l=0; l<height ; ++lineNumber,++l) {
            ...
            for(String word : cells) {                  // For each description
                ...
                model.putCell(l,c++,cell);              // Add cell to the modelGame
            }
        }
    }
