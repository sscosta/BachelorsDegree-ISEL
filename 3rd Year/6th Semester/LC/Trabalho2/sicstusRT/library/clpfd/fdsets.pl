...
must_be_fdset(_Set, Goal, ArgNo) :-
	fd_illarg(domain(term,fdset), Goal, ArgNo).
...
must_be_finite_fdset(_Set, Goal, ArgNo) :-
	fd_illarg(domain(term,finite_fdset), Goal, ArgNo).
...
fdset_parts(Set, Min, Max, RestSet) :-
	...
	Set = Set0.
fdset_parts(Set, Min, Max, RestSet) :-
	fd_illarg(var, fdset_parts(Set,Min,Max,RestSet), 0).
...
fdset_interval(Set, Min, Max) :-
	...
	Set \== [].
fdset_interval(Set, Min, Max) :-
	fd_illarg(var, fdset_interval(Set,Min,Max), 0).
...
fdset_singleton(Set, E) :-
	var(Set), var(E),
	fd_illarg(var, fdset_singleton(Set,E), 0).
...
fdset_size(Set, Size) :-
	var(Set), !,
	fd_illarg(var, fdset_size(Set,Size), 1).
fdset_size(Set, Size) :-
	'$fd_size'(Set, Siz, 1), !,
	Size = Siz.
fdset_size(Set, Size) :-
	fd_illarg(domain(term,fdset), fdset_size(Set,Size), 1).
...
list_to_fdset(List, Set) :-
	fd_illarg(domain(term,integer_list), list_to_fdset(List, Set), 1).
...
fdset_to_list(Set, List) :-
	fdset_to_list(Set, List, []), !.
fdset_to_list(Set, List) :-
	fd_illarg(domain(term,finite_fdset), fdset_to_list(Set, List), 1).
...
range_to_fdset(Range, Set) :-
	set_expression(Range, Set1), !, Set1 = Set.
range_to_fdset(Range, Set) :-
	fd_illarg(domain(term,ground_range_expression), range_to_fdset(Range,Set), 1).
...
fdset_add_element(Set1, Element, Set2) :-
	...
	prolog:must_be(Element, integer, Goal, 2),
