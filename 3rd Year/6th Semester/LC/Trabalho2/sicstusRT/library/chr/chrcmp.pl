...
:- use_module( library('chr/operator')).
...
%%%%% SzT: force(_) severity does not exist any more
info_message( What) :-
	print_message( informational/*force(informational)*/, What).
%%%%%
...
error_message( What, _, _) :-
	print_message( error/*force(error)*/, What).
%%%%%
